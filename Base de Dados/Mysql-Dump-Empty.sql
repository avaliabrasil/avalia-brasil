...
-- -----------------------------------------------------
-- Table `avaliabrasil_dev`.`survey`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `avaliabrasil_dev`.`survey` ;

CREATE TABLE IF NOT EXISTS `avaliabrasil_dev`.`survey` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `datetime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `avaliabrasil_dev`.`answer_likert` (
  ...
  CONSTRAINT `idavaliacao-resp`
    ...
    REFERENCES `avaliabrasil_dev`.`survey` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
