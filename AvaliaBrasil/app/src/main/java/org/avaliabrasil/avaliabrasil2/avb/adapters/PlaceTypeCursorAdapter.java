...
/**
 * {@link PlaceTypeCursorAdapter} exposes a list of Places
 * from a {@link Cursor} to a {@link android.widget.ListView}.
 */
public class PlaceTypeCursorAdapter extends CursorAdapter {
    ...
    public PlaceTypeCursorAdapter(Context context, Cursor c) {
        super(context, c, 0);
    }
